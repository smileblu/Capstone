...
### 💡 ESG 관리 장벽 해소를 위해 탄소배출량 금전적 시각화와 AI 시뮬레이션으로 <br>      개인의 행동 변화와 중소기업 의사결정 지원 서비스

이 서비스는 소규모 기관(개인, 중소기업)이 탄소 배출량을 손쉽게 추적·관리하고, 시계열 예측 및 절감 시뮬레이션을 통해 직관적인 환경 관리와 ESG 보고를 가능하게 하는 클라우드 기반 SaaS입니다.
본 레포지토리는 클라우드 기반 탄소 관리 SaaS의 코드베이스를 관리합니다.
